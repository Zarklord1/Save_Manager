...
class GuiButton : public GuiElement
{
	public:
		...
		//!Destructor
		virtual ~GuiButton();
		//!Sets the button's hitbox
		//!\param w Width
		//!\param h Height
		void setHitbox(f32 w, f32 h);
		//!Sets the button's hitbox
		//!\param x x Position hitbox
		//!\param h y Position hitbox
		void setHitboxStart(f32 x, f32 y);
		...
		f32 getHitboxCenterX();
		f32 getHitboxCenterY();
